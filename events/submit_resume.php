...
<head>
	...
	<title>Submit resume | 'Evoke 19</title>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <h3>Submit your resume</h3>
									...
									<b>	Guidelines</b>
<pre>
> The list of all the companies participating in the Internship/Job Fair is given below.
...
> The Résumé will be evaluated by corresponding companies and the shortlisted candidates will be informed by mail.
> The selected candidates will have to appear for aptitude test/interview during Evoke'19.</pre>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="api_4/index.php" method="post" class="form-class" enctype="multipart/form-data">
                                ...
                                ?>
                                <input type="text" name="fullNameLeader" class="form-control" placeholder="Full Name">
                                ...
                                <input type="tel" name="contactLeader" class="form-control" placeholder="Contact Number">
																<input type="text" name="company" class="form-control" placeholder="Companies">
