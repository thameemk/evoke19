(function() {
                    ...
                    for (var d = 0.86 * f, l = 0.125 * f, m = 0.5 * f, t = Math.random, n = Math.abs, o = z; o--; ) {
                        ...
                        if (w && g < m)
                            var s = 14 * (1 - g / m)
                              , a = a + (c * s + 0.5 - t())
                              , b = b + (k * s + 0.5 - t());
                        g < d && (s = 0.0014 * (1 - g / d) * f,
                        a -= c * s,
                        b -= k * s);
                        g < l && (c = 2.6E-4 * (1 - g / l) * f,
                        a += x * c,
                        b += y * c);
                        a *= B;
                        b *= B;
                ...
                var D = 2 * Math.PI, f = window.innerWidth, p = window.innerHeight, z = 600, B = 0.96, A = [], o, e, n, m, q, r, x, y, u, v, w;
                window.onload = function() {
                    ...
                    if (o.getContext) {
                        ...
                        console.log("Sorry, needs a recent version of Chrome, Firefox, Opera, Safari, or Internet Explorer 9.")
                }
                function resize() {
                        console.log('resize')
                        ...
                        canvasContainer.style.left=''+(-width/2)+'px';
                        canvasContainer.style.top=''+(-height/2)+'px';
                    }
            }
)();
