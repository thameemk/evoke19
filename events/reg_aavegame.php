...
<body class="demo-2">
	...
	<section class="relative custom-section container-fluid" id="trafficmanagement">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <h3>Register for AAVEGAME</h3>
                    <p>

                    <!-- <h4>Register Now</h4><br> -->
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="api_6/index.php" method="post" class="form-class" enctype="multipart/form-data">
                                <?php
                                ...
                                ?>
                                <input type="text" name="fullNameLeader" class="form-control" placeholder="Full Name (Required)">
                                <input type="text" name="instNameLeader" class="form-control" placeholder="Name of the Institution/Organization (Required)">
                                <input type="email" name="emailLeader" class="form-control" placeholder="Email Id (Required)">
                                <input type="tel" name="contactLeader" class="form-control" placeholder="Contact Number (Required)">
                                <div>Team Member 1</div>
                                <input type="text" name="fullNameMember1" class="form-control" placeholder="Full Name (Required)">
                                <input type="tel" name="instNameMember1" class="form-control" placeholder="Contact Number (Required)">
                                <div>Team Member 2</div>
                                <input type="text" name="fullNameMember2" class="form-control" placeholder="Full Name">
                                <input type="tel" name="instNameMember2" class="form-control" placeholder="Contact Number">
                                ...
                                <div class="row btn-group-div">
                                    ...
                                    <input type="hidden" name="theme" value="aavegame1">
